...
function ScheduleView(element, calendar, viewName) {
  ...
  // exports
  t.renderSchedule = renderSchedule;
  ...
  function updateOptions() {
    ...
    unitColTitle = opt('schedUnitColTitle');
  }
  ...
  function buildHeadHTML() {
    ...
    html +=
      "<th class='fc-unit-number " + headerClass + "'>" +
      htmlEscape(unitColTitle) +
      "</th>";
  ...
  function unitName(unitI) {
    if(units[unitI].name) {
      return units[unitI].name;
    } else if (units[unitI].id) {
      return units[unitI].id;
    }
    return '';
  }


  function buildCellHTML(unitI, date) {
    var contentClass = tm + "-widget-content";
  ...
  function setWidth(width) {
    ...
    unitNumberWidth = head.find('th.fc-unit-number').outerWidth();

    colWidth = Math.floor((viewWidth - unitNumberWidth) / colCnt);
